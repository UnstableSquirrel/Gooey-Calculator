...
<main>
   ...
   <div class="nav-container">
      <nav class="menu"> 
         <input type="checkbox" bind:checked={open} href="/" class="menu-open" name="menu-open" id="menu-open" />
...
.slide-container {
   background: linear-gradient(45deg,  rgba(66, 183, 245, 0.4) 0%,rgba(66, 245, 189, 0.5) 100%);
   height: 0px;
   font-size : 0px;
}
